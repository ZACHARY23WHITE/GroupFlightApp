  ...
  return (
    <>
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-10 px-4 py-10 sm:px-6">
        ...
        {loading ? (
          <section
            className="overflow-hidden rounded-2xl border border-stone-200/80 bg-white px-6 py-10 shadow-sm"
            role="status"
            aria-live="polite"
            aria-label="Searching destinations"
          >
            <div className="relative w-full" style={{ height: 80, overflow: "hidden" }}>
              <div
                className="absolute inset-x-0"
                style={{ top: "50%", borderTop: "2px dashed rgb(214 211 208)", zIndex: 0 }}
                aria-hidden
              />
              <div
                aria-hidden
                style={{
                  ...
                  marginTop: -30,
                  zIndex: 1,
                  animation: "pip-fly-across 2.6s linear infinite",
                }}
              >
                <Pip size={60} mood="happy" tilt={-12} />
              </div>
            </div>
            <div className="mt-6 text-center">
              <p className="font-[family-name:var(--font-instrument-serif)] text-xl text-stone-800">
                Exploring destinations…
              </p>
              <p className="mt-1 text-sm text-stone-400">Pip is scouting the skies</p>
            </div>
          </section>
        ) : null}
