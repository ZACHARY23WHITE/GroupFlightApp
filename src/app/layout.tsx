...
import { Geist, Geist_Mono, Instrument_Serif, Plus_Jakarta_Sans, Source_Serif_4 } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${geistSans.variable} ${geistMono.variable} ${sourceSerif.variable} ${plusJakartaSans.variable} ${instrumentSerif.variable} h-full antialiased`}
    >
