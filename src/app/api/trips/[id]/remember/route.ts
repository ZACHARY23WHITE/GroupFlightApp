...
import { forgetTripForUser, rememberTripForUser } from "@/lib/firestore-user-trips";
...
export async function DELETE(req: Request, ctx: Ctx) {
  ...
  try {
    await forgetTripForUser(uid, tripId);
    return NextResponse.json({ ok: true });
  } catch (e) {
    console.error("DELETE /api/trips/[id]/remember:", e);
