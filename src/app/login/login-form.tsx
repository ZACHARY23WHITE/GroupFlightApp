    ...
    <div className="relative flex min-h-[100dvh] flex-col">
      ...
      <main className="relative mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-4 py-12 sm:px-6">
        <div className="flex justify-center">
          <GathrLogo size={36} fontSize={22} />
        </div>
        <h1 className="mt-4 text-center font-[family-name:var(--font-instrument-serif)] text-2xl font-normal tracking-tight text-stone-900">
          Sign in
        </h1>
        <p className="mt-2 text-center text-sm leading-relaxed text-stone-500">
          Use the email and password you chose at signup, or a linked social
          account.
        </p>
