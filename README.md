...
Add the same env vars as `web/.env` under the backend’s **Environment** settings (and use Secret Manager for `FIREBASE_PRIVATE_KEY` / `SERPAPI_API_KEY` in production).
